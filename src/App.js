  ...
  return (
    <div className="App">
      <form onSubmit={(e)=>handleSubmit(e)}>
        <textarea rows={5} onChange={e => handleTextChange(e)} required></textarea>
        <label htmlFor="character">Target Character</label>
        <input name="character" type="text" onChange={(e) => handleCharacterChange(e)} required></input>
        <label htmlFor="isSentence">Check on sentence?</label>
        <input name="isSentence" type="checkbox" defaultChecked={isSentence} onChange={() => handleRangeChange()}></input>
